...
- TASK TYPE RENAME (Durand 2026-09-21, chose "Hands-on" over Work / Do): backend 2026-09-21.6 / UI
  ...
  record.
- Deployed 2026-09-22 07:55 EDT: web app @93 = backend 2026-09-21.6 / UI 2026-09-21.9 (the Hands-on
  rename) = commit b3847cb, `main` fast-forwarded. The clasp token had expired again (`invalid_rapt`,
  overnight after the 9/21 14:52 login; the first attempt was 9/21 ~20:10 EDT). FIFO WRITER RULE: the `( sleep … > fifo & )` form inside the
